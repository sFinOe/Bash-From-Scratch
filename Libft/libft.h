...
/*   Updated: 2022/10/07 12:16:27 by zkasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_strncmplus(const char *str1, const char *str2,
			size_t start, size_t len);
char	*ft_strtrimplus(char const *s1, int c);
char	*ft_substr2(char const *s, size_t start, size_t len);
int		ft_strncmplus2(const char *str1, const char *str2,
			size_t start, size_t len);
char	*ft_strjoinx2(char *s1, char *s2);
int		ft_strncmplus3(char *str1, char *str2, size_t start, size_t len);
